...
<div class="container">
  <div class="row">
    <div class="col-md-4">
      <div class="card mt-2">
        <div class="card-header text-white" style="background-color: #000000;"> Tambah Album </div>
          <div class="card-body">
    ...
    <div class="col-md-8">
    <div class="card mt-2">
      <div class="card-header text-white" style="background-color: #000000;"> Data Album </div>
        <div class="card-body">
          <table class="table">
            <thead>
              <tr>
