  ...
  <div class="container">
	...
	<div class="container" >
		<div class="row">
			<div class="col-md-4">
				<div class="card mt-2">
					<div class="card-header text-white" style="background-color: #000000;"> Tambah Foto </div>
						<div class="card-body">
						...
						<button type="submit" class="btn btn-outline-primary mt-3" name="tambah"> Tambah Foto </button>
						</form>
						</div>
				</div>
			</div>
		...
		<div class="col-md-8">
			<div class="card mt-2">
		<div class="card-header text-white" style="background-color: #000000;"> Data Galeri Foto </div>
			<div class="card-body">
		<table class="table">
		<thead>
		<tr>
			...
			<th> Aksi </th>
				...
				<?php } ?>
					...
					<input type="file" class="form-control" name="lokasifile" >
										...
										<button type="button" class="btn btn-danger mt-1" data-bs-toggle="modal" data-bs-target="#hapus<?php echo $data['fotoid'] ?>"> Hapus </button>
